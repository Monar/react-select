...
const Select = React.createClass({
	...
	renderClear () {
		...
		const clear = this.props.clearRenderer({ bemNames });

		return (
			<span className={this.props.bemNames('clear-zone')}
	...
	renderArrow () {
		...
		const isOpen = this.state.isOpen;
		const bemNames = this.props.bemNames;
		const arrow = this.props.arrowRenderer({ onMouseDown, isOpen, bemNames });
